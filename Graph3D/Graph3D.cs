                    ...
                    else // separate scatter points
                    {
                        ...
                        switch (i_Scatter.me_Shape)
                        {
                            case eScatterShape.Circle:
                                i_Graph.FillEllipse(i_Brush, i_Scatter.mk_Point.X, i_Scatter.mk_Point.Y, i_Scatter.ms32_Diameter, i_Scatter.ms32_Diameter);
                                break;

                            case eScatterShape.Square:
                                i_Graph.FillRectangle(i_Brush, i_Scatter.mk_Point.X, i_Scatter.mk_Point.Y, i_Scatter.ms32_Diameter, i_Scatter.ms32_Diameter);
                                break;
